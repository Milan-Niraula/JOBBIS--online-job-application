...
<body>
       ...
       <div class="popup-form dashboard-main">
                ...
                <a class="btn btn-danger" <?php echo " href='admin-dashboard-client.php' title='back to main page'" ; ?>>x</a>
                </div>
        <div class="dashboard-main">    
            ...
            <div class="row">
                <div class = col-3>
                <a class="btn btn-danger" <?php echo " href='admin-dashboard-client.php' title='back to main page'" ; ?>> Show Less</a>
                    </div>
            <!-- dashboard ends -->
        </div>
    </div>
